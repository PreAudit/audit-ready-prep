...
import preauditLogo from "@/assets/preaudit-logo.png";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-security-muted to-background">
      ...
      <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen text-center">
        ...
        {/* Brand Name */}
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-primary via-security to-primary bg-clip-text text-transparent">
          PreAudit
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl text-center">
          <div className="p-6 rounded-lg bg-card/50 border border-security/10 backdrop-blur-sm">
            <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-r from-primary to-security flex items-center justify-center">
          ...
          <div className="p-6 rounded-lg bg-card/50 border border-security/10 backdrop-blur-sm">
            <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-r from-security to-primary flex items-center justify-center">
              <Zap className="w-6 h-6 text-white" />
            </div>
            <h3 className="font-semibold text-foreground mb-2">Faster Audits</h3>
            <p className="text-sm text-muted-foreground">Reduce audit time by 30-50% with proper preparation</p>
          </div>
          ...
          <div className="p-6 rounded-lg bg-card/50 border border-security/10 backdrop-blur-sm">
            ...
            <h3 className="font-semibold text-foreground mb-2">Actionable Reports</h3>
